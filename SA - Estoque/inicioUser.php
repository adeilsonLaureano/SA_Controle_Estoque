        ...
        <div class="row">
          <div class="col-sm-2 sidebar bg-dark">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link sidebar-nav-link disabled" href="#">Estatísticas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link sidebar-nav-link disabled" href="Cadastro_Login/registerUser.php" target="conteudo">Usuários</a>
              </li>
            </ul>
          ...
          <div class="col-sm-2">
            ...
            <div class="btn-group content2">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item disabled" href="#">Gerenciar</a></li>
            ...
            <p class="my-5">Olá Usuário, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Bem vindo ao nosso site.</p>
